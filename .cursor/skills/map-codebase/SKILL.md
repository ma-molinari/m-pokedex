---
description: Understand existing project structure before adding features. Trigger "Map codebase", "Analyze existing code", "Document current architecture"
globs: []
alwaysApply: false
---
